  ...
  return <main className="workspace">
    ...
    <section className="settingsGrid">
      <article className="featureCard settingsCard">
        ...
        <p>Gemini player discovery now uses Google's Interactions API. Web grounding remains optional.</p>
        ...
        <label className="toggleRow"><input type="checkbox" checked={geminiGrounding} onChange={(event) => setGeminiGrounding(event.target.checked)} /><span><strong>Google Search grounding</strong><small>Off by default. Enable only when your Gemini API project/tier supports Search grounding.</small></span></label>
      </article>
      <article className="featureCard settingsCard">
